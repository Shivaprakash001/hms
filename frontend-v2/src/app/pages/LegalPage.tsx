...
export function LegalPage() {
  ...
  useEffect(() => {
    ...
    let pageTitle = "Legal & Policies | Sri Adithya Boys Hostel";
    let metaDescription = "Legal policies, terms and conditions, privacy policy, and refund rules for Sri Adithya Boys Hostel.";
    let canonicalUrl = "https://www.sriadithyahostels.in/legal";

    if (activeSectionId === 'terms') {
      pageTitle = "Terms & Conditions | Sri Adithya Boys Hostel";
      metaDescription = "Read the Terms & Conditions for utilizing Sri Adithya Boys Hostel platform and accommodation services.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/terms";
    } else if (activeSectionId === 'privacy') {
      pageTitle = "Privacy Policy | Sri Adithya Boys Hostel";
      metaDescription = "Privacy Policy for Sri Adithya Boys Hostel. Learn how we collect, process, and protect tenant and payment data.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/privacy";
    } else if (activeSectionId === 'refund') {
      pageTitle = "Refund & Cancellation Policy | Sri Adithya Boys Hostel";
      metaDescription = "Official Refund and Cancellation Policy for Sri Adithya Boys Hostel bookings and rent payments.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/refund-policy";
    } else if (activeSectionId === 'shipping') {
      pageTitle = "Shipping & Delivery Policy | Sri Adithya Boys Hostel";
      metaDescription = "Shipping and Delivery Policy for Sri Adithya Boys Hostel digital receipts and online accommodation services.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/shipping-policy";
    } else if (activeSectionId === 'contact') {
      pageTitle = "Contact Us | Sri Adithya Boys Hostel";
      metaDescription = "Get in touch with Sri Adithya Boys Hostel for customer support, payment inquiries, and grievance redressal.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/contact";
    } else if (activeSectionId === 'data-deletion') {
      pageTitle = "Data Deletion Instructions | Sri Adithya Boys Hostel";
      metaDescription = "Instructions on requesting account deletion and personal data removal from Sri Adithya Boys Hostel.";
      canonicalUrl = "https://www.sriadithyahostels.in/legal/data-deletion";
    }
    ...
    ldJsonScript.textContent = JSON.stringify({
      ...
      "publisher": {
        ...
        "url": "https://www.sriadithyahostels.in"
      }
    });
