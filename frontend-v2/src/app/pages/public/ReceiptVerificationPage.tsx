...
export function ReceiptVerificationPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'Verify Payment Receipt | Sri Adithya Boys Hostel';
    const desc = document.querySelector('meta[name="description"]');
    desc?.setAttribute(
      'content',
      'Verify the authenticity of digital payment receipts issued by Sri Adithya Boys Hostel, Hyderabad.'
    );
  }, []);
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-2xl border border-red-100 shadow-xl overflow-hidden animate-fadeIn">
            ...
            <div className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a
                  href="mailto:sriadithyahostels@gmail.com"
            ...
            <div className="bg-[#1B2D5B] py-6 px-6 relative overflow-hidden">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="text-xl font-bold text-white m-0 tracking-tight">Sri Adithya Boys Hostel</h2>
                </div>
              </div>
            </div>
