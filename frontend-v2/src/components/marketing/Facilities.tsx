import { Wifi, Droplet, Sparkles, Shield, Camera, WashingMachine, Lock, Zap, UtensilsCrossed } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          {facilities.map((facility, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow flex flex-col items-center text-center border border-[#F07B1D]/10"
              >
