  ...
  return (
    <section className="bg-white py-10 md:py-24" id="gallery">
      ...
      {selectedIndex !== null && currentImage && (
        <div
          className="fixed inset-0 z-[150] flex flex-col items-center justify-between bg-black/95 backdrop-blur-md p-4 transition-all duration-300 animate-fade-in"
        ...
        >
          ...
          <div className="relative flex flex-1 items-center justify-center w-full max-w-5xl my-4">
            ...
            <img
              ...
              className="max-h-[72vh] md:max-h-[80vh] max-w-full rounded-lg object-contain shadow-2xl transition-transform duration-300 animate-zoom-in"
            />
