...
import { Play, Pause, Volume2, VolumeX, Maximize, Bed, Building2, UtensilsCrossed } from 'lucide-react';
...
export function VideoPlayer() {
  ...
  const activeVideo = TOUR_VIDEOS.find((v) => v.id === activeTab) || TOUR_VIDEOS[0];
