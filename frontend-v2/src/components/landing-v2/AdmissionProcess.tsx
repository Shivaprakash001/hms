...
import type { AdmissionStepContent, HostelProfileContent } from '@lib/sanity/landingContent';
...
export function AdmissionProcess({
  ...
  const whatsappUrl = `https://api.whatsapp.com/send?phone=${cleanPhone}&text=Hi%2C%20I%27m%20interested%20in%20seeking%20admission%20at%20Sri%20Adithya%20Hostel`;
  ...
  return (
    <section className="py-10 md:py-24 bg-[#FFFDF5]">
      <div className="max-w-7xl mx-auto px-4">
        <ScrollReveal>
          <h2
            className="text-3xl md:text-4xl text-center text-[#1B2D5B] mb-3 md:mb-4 font-bold"
              ...
              return (
                <StaggerItem key={index}>
                  <div className="flex flex-col items-center relative" style={{ width: '180px' }}>
                    ...
                    <h3 className="font-bold text-[#1B2D5B] mb-2 text-center text-sm">
                      {step.title}
                    </h3>
