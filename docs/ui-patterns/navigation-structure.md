...
| Bottom navigation | Direct route switch | Dashboard sections change without swipe gestures or icon scale animation. |
...
4. Mobile dashboard navigation uses immediate route changes instead of slide gestures.
