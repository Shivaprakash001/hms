...
**Current state:** `frontend-v2/src/app/components/views/RenewalQueueView.tsx` — one 1,388-line component, two tabs (`'expiring' | 'offers'`), backed by:
