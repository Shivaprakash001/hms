...
`backend-next/prisma/schema.prisma` currently defines:
...
`frontend-v2/src/shared/types/moveout.ts` currently lists:
...
- `backend-next/lib/services/move-out-state-machine.ts`
- `backend-next/lib/services/move-out-service.ts`
- `backend-next/app/api/move-out/requests/[id]/complete/route.ts`
- `backend-next/app/api/move-out/requests/[id]/vacate/route.ts`
- `backend-next/app/api/cron/move-out-releases/route.ts`
- `backend-next/lib/services/move-out-notifications.ts`
- `backend-next/lib/services/notifications/owner-whatsapp-assistant.ts`
- `backend-next/lib/services/notifications/briefing-engine.ts`
- `backend-next/src/services/payments/financial-domain.ts`
- `backend-next/src/services/payments/merchant-context.ts`
- `backend-next/src/services/payments/payment-service.ts`

### Frontend

- `frontend-v2/src/shared/types/moveout.ts`
- `frontend-v2/src/features/tenants/components/moveout/MoveOutStepper.tsx`
- `frontend-v2/src/app/components/views/MoveOutsView.tsx`
- `frontend-v2/src/features/tenants/components/profile/ExitWorkflowSection.tsx`
- `frontend-v2/src/portal/pages/TenantMoveOutPage.tsx`
- `frontend-v2/src/features/tenants/components/badges/TenantStatusBadge.tsx`
- `frontend-v2/src/app/components/hostel-detail/tabs/OverviewTab.tsx`
- `frontend-v2/src/app/components/hostel-detail/tabs/MoveOutsTab.tsx`
