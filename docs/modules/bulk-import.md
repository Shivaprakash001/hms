...
> **Needs clarification:** `frontend-v2` has service wrappers for bulk import, but visible v2 bulk import pages were not found. Legacy `frontend/` contains the strongest UI evidence.
