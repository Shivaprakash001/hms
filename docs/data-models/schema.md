...
This file documents every Prisma model found in `backend-next/prisma/schema.prisma`. It is generated from the schema shape, then explained for rebuild use.
