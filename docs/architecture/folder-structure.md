...
|---|---|
| `frontend-v2/` | Canonical future React UI. |
| `backend-next/` | Canonical Next.js API, admin pages, Prisma schema, and services. |
...
**How this works:**
1. Product behavior is reconstructed from `frontend-v2` and `backend-next`.
...
**How this works:**
1. Use `frontend-v2` for canonical screen behavior.
