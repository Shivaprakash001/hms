                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between text-xs text-slate-400 font-bold">
                            ...
                            <div className="flex items-center gap-3">
                                <a href="https://trishul.solutions/legal#terms" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 transition-colors">Terms</a>
                                <a href="https://trishul.solutions/legal#privacy" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 transition-colors">Privacy</a>
                                <a href="https://trishul.solutions/legal#refund" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600 transition-colors">Refund</a>
                            </div>
                        </div>
                    </div>
                </div>
