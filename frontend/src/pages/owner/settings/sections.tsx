        ...
        <section aria-labelledby="notifications-heading">
            <FormShell section={sectionById.notifications} activeHostel={activeHostel} formState={state} onSubmit={handleSubmit(state.submit)} onBack={onBack}>
                ...
                <SettingsCard title="Channels">
                    ...
                    <ChannelRow icon={MessageCircle} tone="green" title="WhatsApp" description="Send rent reminders through WhatsApp" checked={watch('reminder_whatsapp')} onChange={(v: boolean) => setValue('reminder_whatsapp', v, { shouldDirty: true })} />
                </SettingsCard>
