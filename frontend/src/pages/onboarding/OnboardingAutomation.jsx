...
import { Zap, Calendar, Bell, IndianRupee, ArrowRight, ShieldAlert, Clock } from 'lucide-react';
...
export default function OnboardingAutomation() {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 p-8 md:p-12 max-w-2xl mx-auto">
