...
export default function OnboardingWelcome() {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 p-8 md:p-12 overflow-hidden relative">
      ...
      <div className="space-y-6 text-center">
        <Button 
          ...
          className="w-full max-w-sm mx-auto h-14 bg-brand-gradient hover:opacity-90 text-white rounded-2xl font-bold text-lg transition-all duration-300 shadow-xl shadow-purple-200 flex items-center justify-center gap-3 group"
        >
          Start Setup
