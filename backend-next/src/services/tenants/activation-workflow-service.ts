  ...
  categories: [
    {
      ...
      severity: "important",
      icon: "receipt",
      highlights: ["Rent is due as per the hostel billing cycle.", "Late fees may apply after the grace period.", "Refunds follow hostel policy and pending deductions."],
      rules: [
        "Monthly rent and maintenance charges must be paid by the due date.",
        "Advance deposit adjustments, deductions, and refunds are handled by hostel management.",
      ],
    },
    {
      id: "discipline",
      ...
      severity: "standard",
      icon: "shield",
      highlights: ["Respect quiet hours, roommates, staff, and common areas."],
      rules: [
        "Tenants must maintain respectful conduct inside the hostel.",
        "Repeated misconduct can lead to penalties or move-out action according to hostel policy.",
      ],
    },
    {
      id: "visitors",
      ...
      severity: "important",
      icon: "lock",
      highlights: ["Visitors are allowed only according to hostel security rules."],
      rules: [
        "Visitor entry, timing, and identity requirements are controlled by hostel management.",
        "Tenants must follow gate timing and security instructions.",
      ],
    },
    {
      id: "facilities",
      ...
      severity: "standard",
      icon: "wifi",
      highlights: ["Facilities are shared and must be used responsibly."],
      rules: [
        "Shared spaces, WiFi, water, electricity, and other facilities must be used responsibly.",
        "Misuse or disruption of hostel facilities may attract penalties.",
      ],
    },
    {
      id: "damages",
      ...
      severity: "critical",
      icon: "alert-triangle",
      highlights: ["Property damage costs can be charged to the tenant."],
      rules: [
        "Damage to hostel property, room fixtures, or shared assets may be charged to the responsible tenant.",
        "Management may deduct verified damages from deposit or collect them separately.",
      ],
    },
    {
      id: "vacating",
      title: "Vacating Rules",
      severity: "important",
      icon: "door-open",
      highlights: ["Move-out requires notice and room handover clearance."],
      rules: [
        "Tenants must follow hostel notice, settlement, and handover process before vacating.",
        "Pending dues, damages, and key/property handover must be cleared before final exit.",
      ],
    },
  ],
