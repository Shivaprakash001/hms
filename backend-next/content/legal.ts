...
export const legalSections: LegalSection[] = [
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "The Platform is owned by Sri Adithya Hostels, a company incorporated under the Companies Act, 1956 with its registered office at Kodangal (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').",
      },
      {
        type: "paragraph",
